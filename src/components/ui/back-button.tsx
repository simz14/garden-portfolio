...
export function BackButton() {
  ...
  return (
    <button
      ...
      className={cn(
        'cursor-pointer absolute top-20 left-5 z-30 rounded-full bg-white/30 px-3.5 py-2',
        'text-[11px] tracking-[0.18em] text-black/75 ring-1 ring-white/45 ring-inset',
